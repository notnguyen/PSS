...
const int BUTTON_ARDUINO_PIN[3] = {2, 3, 4};  // pins of each button connected straight to the Arduino
...
const int POT_ARDUINO_PIN[2] = {A0, A1};  // pins of each pot connected straight to the Arduino
